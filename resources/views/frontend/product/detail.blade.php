            ...
            <div class="max-w-screen-2xl px-4 mx-auto text-start grid grid-cols-1 content-between h-full">
                ...
                <nav class="flex py-8" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-4">
                        ...
                        <li>
                            <div class="flex items-start">
                                <i class="fa-solid fa-chevron-right w-5 h-3 text-putih pt-1"></i>
                                <a href="{{ url()->current() }}"
                                    class="ms-1 text-lg font-bold w-full text-putih overflow-hidden line-clamp-1 hover:text-white md:ms-2">
                                    @php
        ...
        <div class="max-w-screen-2xl px-4 mx-auto 2xl:px-0">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Detail Produk:</h2>
